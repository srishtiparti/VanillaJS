...
const btnContainer = document.querySelector(".selection-btn");
...
function displayBtns(menuItem) {
    // //getting an array using map... 
    // var buttons = menu.map(function(item) {
    ...
    // using reduce(value,["initial value"])
    ...
    let category = categories.map(function(item) {
